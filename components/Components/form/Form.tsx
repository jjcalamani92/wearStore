                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-6">
                    <div className="col-span-2 grid grid-cols-6 gap-6">
                      <div className="col-span-6 sm:col-span-4">
                        ...
                        <input
                          className="mt-1 focus:ring-red-500 focus:border-red-500 block w-full shadow-sm sm:text-sm  rounded-md  py-2 px-3 border border-gray-300"
                          type={"text"}
                          {...register('name', {
                            onChange: (e) => { },
                            onBlur: (e) => { },
                      ...
                      <div className="col-span-3 sm:col-span-2">
                        ...
                        <input
                          className="mt-1 focus:ring-red-500 focus:border-red-500 block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md  py-2 px-3"
                          type='number'
                          {...register('inStock', {
                            required: 'Este campo es requerido',
                      ...
                      <div className="col-span-6 sm:col-span-2">
                          ...
                          <input
                            className="mt-2 py-2 px-3 focus:ring-red-500 focus:border-red-500 block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md p-1"
                            type={"text"}
                            value={newTagValue}
                ...
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      />
                      <div>
                        {errors.clothing && <span className="text-sm text-red-500">{errors.clothing.message}</span>}
                      </div>
                    </div> 
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      />
                      <div>
                        {errors.form && <span className="text-sm text-red-500">{errors.form.message}</span>}
                      </div>
                    </div> 
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      />
                      <div>
                        {errors.bridge && <span className="text-sm text-red-500">{errors.bridge.message}</span>}
                      </div>
                    </div> 
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      />
                      <div>
                        {errors.rod && <span className="text-sm text-red-500">{errors.rod.message}</span>}
                      </div>
                    </div>  
                  </div>
                  <div className="grid grid-cols-6 gap-6">
